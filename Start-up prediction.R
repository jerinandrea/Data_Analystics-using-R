...
getwd()
dataset = read.csv("C:/Users/Sherly/OneDrive/Documents/R/Start_Ups.csv")
...
#Since the error term is around 0.09, 
#it means there is only 9% error in our model's prediction.
