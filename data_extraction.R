...
#like c1, c2, c3, c4, c5
write.csv(x=mtcars, file='R/mtcars1.csv')
write.csv(x=mtcars, file='R/mtcars2.csv', row.names = F)
...
# Method 2:
c_1 <- read.csv("R/mtcars2.csv")
View(c_1)

newmtcars1 = read.csv(file='R/mtcars2.csv')
head(newmtcars1)
#no car names
